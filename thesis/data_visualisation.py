...
# import data #
###############
df_data, X_train, Y_train, X_test, Y_test, Y_test_unscaled, dict_historical_means, scaler_features, scaler_labels = import_and_clean_data(data_path,test_start_date,train_end_date,num_bck_timeframes,num_weeks_per_bck_timeframe,num_fwd_timeframes,num_weeks_per_fwd_timeframe)
...
titles = ['(a) Global','','(b) S&P/ASX 200', '(c) DAX', '(d) Euro Stoxx 50', '(e) Nasdaq-100', '(f) Nikkei 225', '(g) S&P 500']
